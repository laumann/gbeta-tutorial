...
\renewcommand{\beta}{\textsc{Beta}\xspace}
 \lstset{
         basicstyle=\normalsize\ttfamily, % Standardschrift
 ...
 %        stringstyle=\color{white}\ttfamily, % Farbe der String
         ...
         showstringspaces=false,      % Leerzeichen in Strings anzeigeqn
                                % ?
         morekeywords={for,do,else,if,then,case,\?,ORIGIN,BODY,INCLUDE},%
         morecomment=[l]//,%
         string=[b]{'}
 }
